...
data = {
    "song_title": [
        ...
        "Suttrum Boomi", 
        "Chinna Chinna Aasai", 
        "Vaadi Pulla Vaadi",           # New Song
        "Pakkam Vanthu",              # New Song
        "Yaaradi Nee Mohini",         # New Song
        "Kanna Veesi",       # New Song
        "Thuli Thuli",                 # New Song
        "Marana Mass",                # New Song
        "Ninaithale Inikkum",         # New Song
        "Kannana Kanne",              # New Song
        "Sakkarai Nilave",            # New Song
        "Pudhu Pudhu Arthangal"       # New Song
    ],
    "mood": [
        "happy", 
        "romantic", 
